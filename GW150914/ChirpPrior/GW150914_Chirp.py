...
with open("chirpmass_prior_data.txt", "r") as file:
...
priors = bilby.gw.prior.BBHPriorDict(filename="ChirpMass.prior")

priors["chirp_mass"] = bilby.prior.Interped(name="chirp_mass",xx=chirpmass_samples, yy=numpy.exp(log_density))
